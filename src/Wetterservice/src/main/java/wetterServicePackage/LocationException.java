 ...
 */
public class LocationException extends TException implements org.apache.thrift.TBase<LocationException, LocationException._Fields>, java.io.Serializable, Cloneable, Comparable<LocationException> {
  ...
  static {
    schemes.put(StandardScheme.class, new LocationExceptionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new LocationExceptionTupleSchemeFactory());
  }
  ...
  public LocationException setLocation(Location location) {
    this.location = location;
    return this;
  }
  ...
  public LocationException setWhy(String why) {
    this.why = why;
    return this;
  }
  ...
  private static class LocationExceptionStandardSchemeFactory implements SchemeFactory {
    public LocationExceptionStandardScheme getScheme() {
      return new LocationExceptionStandardScheme();
    }
  }

  private static class LocationExceptionStandardScheme extends StandardScheme<LocationException> {
  ...
  private static class LocationExceptionTupleSchemeFactory implements SchemeFactory {
    public LocationExceptionTupleScheme getScheme() {
      return new LocationExceptionTupleScheme();
    }
  }

  private static class LocationExceptionTupleScheme extends TupleScheme<LocationException> {
