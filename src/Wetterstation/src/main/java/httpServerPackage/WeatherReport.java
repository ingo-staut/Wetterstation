...
public class WeatherReport implements org.apache.thrift.TBase<WeatherReport, WeatherReport._Fields>, java.io.Serializable, Cloneable, Comparable<WeatherReport> {
  ...
  private static final org.apache.thrift.protocol.TField HUMIDITY_FIELD_DESC = new org.apache.thrift.protocol.TField("humidity", org.apache.thrift.protocol.TType.I16, (short)4);
  private static final org.apache.thrift.protocol.TField WIND_STRENGTH_FIELD_DESC = new org.apache.thrift.protocol.TField("windStrength", org.apache.thrift.protocol.TType.I16, (short)5);
  ...
  static {
    schemes.put(StandardScheme.class, new WeatherReportStandardSchemeFactory());
    schemes.put(TupleScheme.class, new WeatherReportTupleSchemeFactory());
  }
  ...
  public short humidity; // required
  public short windStrength; // required
   ...
   * @see Report
   */
  public WeatherReport setReport(Report report) {
    this.report = report;
    return this;
  }
  ...
  public WeatherReport setLocation(Location location) {
    this.location = location;
    return this;
  }
  ...
  public WeatherReport setHumidity(short humidity) {
    this.humidity = humidity;
    setHumidityIsSet(true);
    return this;
  }
  ...
  public void unsetHumidity() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __HUMIDITY_ISSET_ID);
  }

  /** Returns true if field humidity is set (has been assigned a value) and false otherwise */
  public boolean isSetHumidity() {
    return EncodingUtils.testBit(__isset_bitfield, __HUMIDITY_ISSET_ID);
  }

  public void setHumidityIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __HUMIDITY_ISSET_ID, value);
  }

  public short getWindStrength() {
    return this.windStrength;
  }

  public WeatherReport setWindStrength(short windStrength) {
    this.windStrength = windStrength;
    setWindStrengthIsSet(true);
    return this;
  }
  ...
  public void unsetWindStrength() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __WINDSTRENGTH_ISSET_ID);
  }

  /** Returns true if field windStrength is set (has been assigned a value) and false otherwise */
  public boolean isSetWindStrength() {
    return EncodingUtils.testBit(__isset_bitfield, __WINDSTRENGTH_ISSET_ID);
  }

  public void setWindStrengthIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __WINDSTRENGTH_ISSET_ID, value);
  }
  ...
  public void unsetRainfall() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __RAINFALL_ISSET_ID);
  }

  /** Returns true if field rainfall is set (has been assigned a value) and false otherwise */
  public boolean isSetRainfall() {
    return EncodingUtils.testBit(__isset_bitfield, __RAINFALL_ISSET_ID);
  }

  public void setRainfallIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __RAINFALL_ISSET_ID, value);
  }
  ...
  public void unsetAtmosphericpressure() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ATMOSPHERICPRESSURE_ISSET_ID);
  }
  ...
  public boolean isSetAtmosphericpressure() {
    return EncodingUtils.testBit(__isset_bitfield, __ATMOSPHERICPRESSURE_ISSET_ID);
  }

  public void setAtmosphericpressureIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ATMOSPHERICPRESSURE_ISSET_ID, value);
  }
  ...
  public void unsetWindDirection() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __WINDDIRECTION_ISSET_ID);
  }
  ...
  public boolean isSetWindDirection() {
    return EncodingUtils.testBit(__isset_bitfield, __WINDDIRECTION_ISSET_ID);
  }

  public void setWindDirectionIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __WINDDIRECTION_ISSET_ID, value);
  }
  ...
  public WeatherReport setDateTime(String dateTime) {
    this.dateTime = dateTime;
    return this;
  }
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case HUMIDITY:
      return Short.valueOf(getHumidity());

    case WIND_STRENGTH:
      return Short.valueOf(getWindStrength());

    case RAINFALL:
      return Double.valueOf(getRainfall());

    case ATMOSPHERICPRESSURE:
      return Short.valueOf(getAtmosphericpressure());

    case WIND_DIRECTION:
      return Short.valueOf(getWindDirection());
  ...
  private static class WeatherReportStandardSchemeFactory implements SchemeFactory {
    public WeatherReportStandardScheme getScheme() {
      return new WeatherReportStandardScheme();
    }
  }

  private static class WeatherReportStandardScheme extends StandardScheme<WeatherReport> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, WeatherReport struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // WIND_STRENGTH
            if (schemeField.type == org.apache.thrift.protocol.TType.I16) {
              struct.windStrength = iprot.readI16();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WeatherReport struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI16(struct.humidity);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(WIND_STRENGTH_FIELD_DESC);
      oprot.writeI16(struct.windStrength);
      oprot.writeFieldEnd();
  ...
  private static class WeatherReportTupleSchemeFactory implements SchemeFactory {
    public WeatherReportTupleScheme getScheme() {
      return new WeatherReportTupleScheme();
    }
  }

  private static class WeatherReportTupleScheme extends TupleScheme<WeatherReport> {
